...
export default function Studio() {
    ...
    if (isCheckingApiKey || isLoadingTasks) {
        return (
            <div className="flex h-[calc(100dvh-var(--dashboard-navbar-offset))] items-center justify-center bg-[#0a0a0a] text-white">
    ...
    return (
        <div
            ...
            style={{
                ...
                minHeight: 'calc((100dvh - var(--dashboard-navbar-offset)) / 0.8)',
            }}
        >
