...
import { Loader2, Plus, Trash2, ClipboardList, Sparkles, Calculator } from 'lucide-react';
...
const WorkerWeightEditor = ({
    ...
    const refreshAll = useCallback(async () => {
        ...
        try {
            ...
            if (workersError || projectsError || taskTypesError || logsError) {
                throw workersError || projectsError || taskTypesError || logsError;
            }
        ...
        <div className="rounded-[28px] border border-neutral-200 bg-white p-4 shadow-sm">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    ...
                    <p className="mt-1.5 max-w-3xl text-sm leading-5 text-neutral-500">
                        Este período ya no usa weights manuales. El porcentaje workers funciona como techo; el monto efectivamente ganado sale de tipos de tarea, criticidad, seniority y puntos ponderados.
                    </p>
                </div>
            ...
            <div className="mt-4 grid gap-2.5 sm:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="min-w-0 rounded-[20px] border border-neutral-200 bg-neutral-50 p-3">
                    <div className="flex items-center gap-2 text-neutral-500">
                        <Calculator size={14} />
                        <span className="text-[10px] uppercase tracking-[0.22em]">Puntos base</span>
                    </div>
                                            ...
                                            return (
                                                <>
                                                    ...
                                                    <p className="mt-1 text-sm text-neutral-500">
                                                        {getProjectDisplayName(log.project || projectMap[log.project_id])}
                                                        {' · '}
                                                        {taskSummary}
                                                    </p>
                                                    {taskNames.length > 1 && (
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm text-neutral-500">
                            {isClosed
                                ...
                                : 'Se recalcula con los work logs aprobados y el seniority acumulado.'}
                        </p>
                    </div>
                            ...
                            return (
                                <div key={row.worker_id} className="rounded-[18px] border border-neutral-200 bg-neutral-50 p-3">
                                    ...
                                    <div className="mt-3 grid gap-2.5 sm:grid-cols-3">
                                        <div>
                                            <p className="text-[10px] uppercase tracking-[0.22em] text-neutral-400">Puntos base</p>
