...
function buildSystemPrompt(brandDocs = []) {
  const base = [
    ...
    '- El campo "brief_usuario" define el TEMA del copy. Respetalo siempre.',
    '- La identidad del proyecto define el TONO y la VOZ, NO el tema.',
    '- NO menciones el servicio principal del proyecto (ej: SEO, ads, automatización) salvo que el brief lo pida explícitamente.',
    '- Si el brief habla de un caso de éxito, escribí sobre ese caso. No lo conviertas en publicidad del servicio.',
    '- Si el brief es vago, elegí un ángulo útil o inspirador — nunca autopublicitario por defecto.',
    '',
