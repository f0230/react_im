...
export default function ImageViewer({ task, tasks, onClose, onSelect, onUseAsReference }: ImageViewerProps) {
  if (!task) return null;
        ...
        >
          ...
          <div className="w-full lg:w-[400px] flex flex-col gap-6 overflow-y-auto pr-2">
            <div className="space-y-2">
              ...
              <h2 className="text-2xl font-bold tracking-tight">Image Preview</h2>
            </div>
            ...
            <div className="glass-panel p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6 pt-4 border-t border-white/5">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm font-semibold">{new Date(task.createdAt).toLocaleTimeString()}</p>
                </div>
                <div className="space-y-1">
            ...
            <div className="grid grid-cols-1 gap-3 mt-auto">
              <div className="flex gap-3">
                <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 transition-all font-bold"
                >
                  <Download size={20} />
                  Download
                </button>
